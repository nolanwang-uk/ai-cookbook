...
export const sections: Section[] = [
  /* ── Phase 0-1: Foundation ── */
  {
    ...
    subgroups: [
        ...
        topics: [
          {
            ...
            resources: [
              ...
              { name: { zh: "3Blue1Brown「线性代数的本质」系列视频", en: "3Blue1Brown 'Essence of Linear Algebra' video series" }, url: "https://www.youtube.com/playlist?list=PLZHQObOWTQDPD3MizzM2xVFitgF8hE_ab" },
            ...
            zhResources: [
              ...
              { name: "3Blue1Brown 线性代数的本质（官方双语合集·B站）", url: "https://www.bilibili.com/video/BV1ys411472E/" },
            ],
          },
          {
            id: "calculus",
          ...
          },
          {
            ...
            duration: { zh: "3-4 周", en: "3-4 weeks" },
            why: {
              zh: "机器学习本质上是从数据中学习概率分布。损失函数通常来源于最大似然估计。贝叶斯思维支撑着许多现代方法。",
              en: "ML is fundamentally about learning probability distributions from data. Loss functions are often derived from MLE.",
            },
            concepts: {
              zh: ["概率公理、条件概率、贝叶斯定理", "随机变量（离散与连续）", "常见分布：正态、伯努利、泊松、均匀分布等", "期望、方差、协方差与相关性", "联合、边际与条件分布", "最大似然估计（MLE）与最大后验估计（MAP）", "贝叶斯推断基础", "假设检验与置信区间", "采样方法（蒙特卡洛、MCMC 基础）"],
          ...
          },
          {
            ...
            why: { zh: "训练任何模型都是一个优化问题。理解优化器行为对于调试训练和选择超参数至关重要。", en: "Training any model is an optimization problem. Understanding optimizer behavior is critical for debugging and hyperparameter tuning." },
            concepts: {
              zh: ["目标/损失函数、极小值与极大值", "梯度下降（批量、随机、小批量）", "学习率调度与自适应方法（Adam、AdaGrad、RMSProp）", "凸优化 vs 非凸优化", "约束优化与拉格朗日乘子法", "收敛分析基础", "正则化作为优化约束（L1/L2）"],
            ...
            resources: [
              { name: { zh: "《凸优化》Boyd & Vandenberghe（免费 PDF）第 1-5 章", en: "Convex Optimization by Boyd & Vandenberghe (free PDF) Ch 1-5" }, url: "https://web.stanford.edu/~boyd/cvxbook/bv_cvxbook.pdf" },
      ...
      {
        label: { zh: "第一个 ML 项目", en: "Your First ML Project" },
        topics: [
          {
            id: "ml-fundamentals",
            title: { zh: "机器学习基础", en: "Machine Learning Fundamentals" },
            difficulty: { zh: "入门-中级", en: "Beginner-Intermediate" },
            duration: { zh: "2-4 个月", en: "2-4 months" },
            concepts: {
              zh: ["监督学习：回归（线性、岭、Lasso）、分类（逻辑回归、SVM、决策树、随机森林、梯度提升）", "无监督学习：聚类（K-Means、DBSCAN）、降维（PCA、t-SNE、UMAP）", "模型评估：偏差-方差权衡、交叉验证、精确率/召回率/F1、ROC/AUC", "特征工程与特征选择", "集成方法（Bagging、Boosting、Stacking）", "正则化（L1、L2、Dropout、早停）", "核方法与核技巧", "EM 算法"],
              en: ["Supervised learning: regression (linear, ridge, lasso), classification (logistic regression, SVM, decision trees, random forests, gradient boosting)", "Unsupervised learning: clustering (K-Means, DBSCAN), dimensionality reduction (PCA, t-SNE, UMAP)", "Model evaluation: bias-variance tradeoff, cross-validation, precision/recall/F1, ROC/AUC", "Feature engineering and selection", "Ensemble methods (bagging, boosting, stacking)", "Regularization (L1, L2, dropout, early stopping)", "Kernel methods and the kernel trick", "Expectation-Maximization (EM) algorithm"],
            },
            resources: [
              { name: { zh: "《统计学习导论 ISLP》James 等（免费，含 Python 实验）", en: "An Introduction to Statistical Learning (ISLP) — free, with Python labs" }, url: "https://www.statlearning.com/" },
              { name: { zh: "Coursera: 机器学习专项课程（DeepLearning.AI）", en: "Coursera: Machine Learning Specialization (DeepLearning.AI)" }, url: "https://www.coursera.org/specializations/machine-learning-introduction" },
            ...
            zhResources: [
              { name: "吴恩达机器学习 2022（中英字幕·B站）", url: "https://www.bilibili.com/video/BV19B4y1W76i/" },
              { name: "周志华《机器学习》（西瓜书）", url: "https://book.douban.com/subject/26708119/" },
              { name: "南瓜书：西瓜书公式详解（Datawhale）", url: "https://datawhalechina.github.io/pumpkin-book/" },
              { name: "李宏毅机器学习课程（B站）", url: "https://www.bilibili.com/video/BV1TAtwzTE1S/" },
            ],
          },
          {
            id: "data-science",
            title: { zh: "数据科学与分析", en: "Data Science & Analytics" },
            difficulty: { zh: "入门-中级", en: "Beginner-Intermediate" },
            duration: { zh: "2-3 个月", en: "2-3 months" },
            why: { zh: "ML 工程师日常 80% 的时间在处理数据。掌握数据分析工具是一切的基础。", en: "ML engineers spend 80% of their time on data. Mastering data analysis tools is the foundation of everything." },
            concepts: {
              zh: ["数据清洗：缺失值处理、异常值检测、数据转换", "探索性数据分析（EDA）：可视化、统计摘要、相关性分析", "特征工程：编码分类变量、缩放、时间特征", "A/B 测试与实验设计", "SQL 数据查询", "仪表板与商业智能", "时间序列分析与预测"],
              en: ["Data wrangling: cleaning, imputation, outlier handling, transformation", "Exploratory Data Analysis (EDA): visualization, statistical summaries", "Feature engineering: encoding, scaling, time-based features", "A/B testing and experiment design", "SQL for data querying", "Dashboard creation and business intelligence", "Time series analysis and forecasting"],
            },
            resources: [
              { name: { zh: "《Python 数据分析》Wes McKinney", en: "Python for Data Analysis by Wes McKinney" }, url: "https://wesmckinney.com/book/" },
  ...
  {
    id: "go-deep",
    title: { zh: "深入深度学习", en: "Go Deep" },
    emoji: "🏊",
    phase: { zh: "进阶 · 3-5 个月", en: "Level Up · 3-5 months" },
    description: {
      zh: "深度学习是现代 AI 的核心引擎。这个阶段你会理解从感知器到 Transformer 的完整架构演进，并能独立训练模型。",
      en: "Deep learning is the engine of modern AI. In this phase you'll understand the full architecture evolution from perceptrons to Transformers and train models independently.",
    },
    subgroups: [
      {
        label: { zh: "核心技能", en: "Core Skills" },
        topics: [
          {
            id: "deep-learning",
            title: { zh: "深度学习", en: "Deep Learning" },
            difficulty: { zh: "中级", en: "Intermediate" },
            prereqs: { zh: "机器学习基础 + 数学基础", en: "ML Fundamentals + Math Foundations" },
            duration: { zh: "3-5 个月", en: "3-5 months" },
            concepts: {
              zh: ["神经网络基础：感知器、激活函数（ReLU、GELU、SiLU）、万能近似定理", "反向传播与计算图", "权重初始化（Xavier/He）", "归一化：BatchNorm、LayerNorm、RMSNorm", "优化器：SGD、Adam、AdamW、余弦退火、Warmup", "卷积神经网络（CNN）：卷积、池化、ResNet、EfficientNet", "循环神经网络（RNN）：LSTM、GRU、Seq2Seq", "Transformer：自注意力、多头注意力、位置编码、编码器-解码器架构", "残差连接与跳跃连接", "混合精度训练、梯度累积、梯度检查点"],
              en: ["Neural network fundamentals: perceptrons, activation functions (ReLU, GELU, SiLU), universal approximation theorem", "Backpropagation and computational graphs", "Weight initialization (Xavier/He)", "Normalization: BatchNorm, LayerNorm, RMSNorm", "Optimizers: SGD, Adam, AdamW, cosine annealing, warmup", "CNNs: convolution, pooling, ResNet, EfficientNet", "RNNs: LSTM, GRU, Seq2Seq", "Transformers: self-attention, multi-head attention, positional encoding, encoder-decoder", "Residual connections and skip connections", "Mixed-precision training, gradient accumulation, gradient checkpointing"],
            },
            resources: [
              { name: { zh: "《深度学习》Goodfellow 等（深度学习圣经，免费在线）", en: "Deep Learning by Goodfellow, Bengio, Courville (free online)" }, url: "https://www.deeplearningbook.org/" },
              { name: { zh: "《动手学深度学习 d2l.ai》（免费、交互式）", en: "Dive into Deep Learning (d2l.ai) — free, interactive" }, url: "https://d2l.ai/" },
              { name: { zh: "fast.ai 实践深度学习课程", en: "fast.ai Practical Deep Learning for Coders" }, url: "https://course.fast.ai/" },
              { name: { zh: "Andrej Karpathy「Neural Networks: Zero to Hero」", en: "Andrej Karpathy 'Neural Networks: Zero to Hero'" }, url: "https://www.youtube.com/playlist?list=PLAqhIrjkxbuWI23v9cThsA9GvCAUhRvKZ" },
            ],
            zhResources: [
              { name: "李沐《动手学深度学习》V2 PyTorch版（B站）", url: "https://www.bilibili.com/video/BV1f5411P769/" },
              { name: "《动手学深度学习》中文在线版", url: "https://zh.d2l.ai/" },
              { name: "邱锡鹏《神经网络与深度学习》（免费在线）", url: "https://nndl.github.io/" },
            ],
          },
        ],
      },
